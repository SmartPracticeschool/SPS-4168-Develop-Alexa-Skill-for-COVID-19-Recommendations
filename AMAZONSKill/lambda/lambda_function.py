...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome, Lets start with Knowing about COVID-19.This is very important for preventing ourselves and our family from getting infected. You can ask for national or state covid 19 data. May I know Your Name, Location and Temparature Before Starting.."
...
class IndiaCasesIntentHandler(AbstractRequestHandler):
    """Handler for India Cases Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("IndiaCasesIntent")(handler_input)
...
class HelloWorldIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Hello World! Any time If you need me to Show My Presence !!I am available for you always !! Anytime and Anywhere!!!" 
...
class addInfo(AbstractRequestHandler):
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("addInfo")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        url = "https://2y3co6lxj4.execute-api.us-east-1.amazonaws.com/personDetails?personName="+str(person_name_value)+"&personLocation="+str(person_location_value)+"&Temparature="+str(temparature_value)
        response = requests.get(url)
        speak_output=" Your Details are Registered {}, I hope It's wounderful Growing up at {}, Must be very fascinating to you. Okay, Having {} Temparature You dont need to worry! I Wish I could help you more, Please check @https://covidindia.org/ For more information and guidelines about COVID-19".format(person_name_value, person_location_value, temparature_value)
...
class QuestionAlexaHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output=" Here I am designed to have a healthy conversation regarding COVID 19 and To guide you through. Any further question you can Feel free to ask.Stay Home Stay Safe."
...
class MildConditionHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output="Hey! I guess you have nothing to worry much, Anyway, Please maintain social distance,wear mask and maintain sanitation and stick to precautions. There are mild chances that you can get infected by Corona Virus "
...
class SevereConditionHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output="Hey There ! It seems you have to be very careful, for the sake of you and others too. Please Try to make a COVID/RT-PCR Test as soon as possible. Take effective Care and Consultation. You may be having Severe Condition with respect to Corona Virus"
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Goodbye! Stay Home Stay Safe!"
...
sb.add_request_handler(IndiaCasesIntentHandler())
sb.add_request_handler(StateCasesIntentHandler())
sb.add_request_handler(HelloWorldIntentHandler())
sb.add_request_handler(addInfo())
